...
export async function startChallengeWith(supabase, {
  ...
  // "My gym" means nothing to a member with no gym, and the gym rule treats
  // a NULL gym as everyone. On their own it is invite only.
  if (!gymId && visibility === 'gym') visibility = 'invite'
